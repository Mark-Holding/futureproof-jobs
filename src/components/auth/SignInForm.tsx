...
export default function SignInForm({ onSuccess, userType = 'jobseeker' }: SignInFormProps) {
      ...
      >
        {isSubmitting ? (
          <span className="flex items-center">
            ...
            {userType === 'employer' ? 'Signing in...' : 'Signing in...'}
          </span>
        ) : (userType === 'employer' ? 'Sign In as Employer' : 'Sign In')}
      </button>
    </form>
  )
} 